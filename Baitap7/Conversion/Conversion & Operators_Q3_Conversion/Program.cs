...
class Program
{
    static void Main()
    {
        ...
        // Đổi chiều cao sang inches
        int totalHeightInches = (feet * 12) + inches;

        // Tính BMI
        double bmi = (weight * 703) / (totalHeightInches * totalHeightInches);
...
class Program
{
    static void Main()
    {
        ...
        // In với 1 chữ số thập phân
        Console.WriteLine("Player's Score: " + score);
        Console.WriteLine("Player's Score with one decimal place: " + scoreDouble.ToString("F1"));
    }
}*/
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Player's Health as a percentage: " + healthPercent + "%");
    }
}*/
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Player's Coins as an integer: " + coinsInt);
    }
}*/
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Player's Progress: " + progress);
        Console.WriteLine("Player's Progress as a string: " + status);
    }
}
